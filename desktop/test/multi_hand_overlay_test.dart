...
void main() {
  ...
  testWidgets('OverlayModel は2骨格＋2カーソルを別トラックとして保持する',
    ...
    model.showSkeletons({7: _asVec(hand7Landmarks), 12: _asVec(hand12Landmarks)});
    model.applyTrackEvents({
      7: [const InteractionEvent(InteractionKind.pointerMove, Vec2(0.27, 0.31))],
    ...
    model.applyTrack(12, const InteractionEvent(InteractionKind.release, Vec2(0, 0)));
